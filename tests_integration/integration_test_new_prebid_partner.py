...
class NewPrebidPartnerTests(TestCase):
  ...
  def tearDown(self):
    ...
    # https://developers.google.com/doubleclick-publishers/docs/reference/v201802/CustomTargetingService.DeleteCustomTargetingKeys
    # https://developers.google.com/doubleclick-publishers/docs/reference/v201802/CustomTargetingService.DeleteCustomTargetingValues
