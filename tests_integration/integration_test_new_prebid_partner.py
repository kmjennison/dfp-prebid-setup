...
class NewPrebidPartnerTests(TestCase):
  ...
  def tearDown(self):
    ...
    # https://developers.google.com/doubleclick-publishers/docs/reference/v202108/CustomTargetingService.DeleteCustomTargetingKeys
    # https://developers.google.com/doubleclick-publishers/docs/reference/v202108/CustomTargetingService.DeleteCustomTargetingValues
